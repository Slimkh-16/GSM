!function(n, t, i) {
    ...
    e.prototype = {
        ...
        init: function() {
            var t = this;
            return t.config = n.extend({}, t.defaults, t.options, t.metadata),
            "" !== t.config.filter && (t.$nav = t.$nav.filter(t.config.filter)),
            t.$nav.on("click.onePageNav", n.proxy(t.handleClick, t)),
            t.getPositions(),
            t.bindInterval(),
            t.$win.on("resize.onePageNav", n.proxy(t.getPositions, t)),
            this
        },
        ...
        getPositions: function() {
            ...
            s.$nav.each(function() {
                t = s.getHash(n(this)),
                e = n("#" + t),
                e.length && (i = e.offset().top,
                s.sections[t] = Math.round(i) - s.config.scrollOffset)
            }
            )
        },
        ...
        handleClick: function(i) {
            var e = this
              ...
              , o = s.parent()
              , a = "#" + e.getHash(s);
            o.hasClass(e.config.currentClass) || (e.config.begin && e.config.begin(),
            e.adjustNav(e, o),
            e.unbindInterval(),
            n.scrollTo(a, e.config.scrollSpeed, {
                axis: "y",
                easing: e.config.easing,
                offset: {
                    top: -e.config.scrollOffset - 100
                },
                onAfter: function() {
                    e.config.changeHash && (t.location.hash = a),
                    e.bindInterval(),
                    e.config.end && e.config.end()
                }
            })),
            i.preventDefault()
        },
        scrollChange: function() {
            ...
            null  !== i && (n = this.$elem.find('a[href$="#' + i + '"]').parent(),
